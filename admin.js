...
document.getElementById('formPegawai').addEventListener('submit', function(e) {
    ...
    const data = {
        ...
        NamaPendekPosisiAtasan: document.getElementById('NamaPendekPosisiAtasan').value,
        NamaPanjangPosisiSIMKP: document.getElementById('NamaPanjangPosisiSIMKP').value,
        PersonnelNumberAtasan: document.getElementById('PersonnelNumberAtasan').value,
    ...
    db.collection("pegawai").doc(nipegValue).set(data)
        .then(() => {
...
function deletePegawai(id) {
    ...
    db.collection("pegawai").doc(id).delete()
        .then(() => {
